...
grpc:
  server:
    port: 9091
  client:
    customer-service:                    # logical name (matches @GrpcClient annotation)
...
option java_multiple_files = true;
option java_package = "com.arister.proto.ewallet";
...
public class UserServiceImpl extends UserServiceGrpc.UserServiceImplBase {
    ...
    public void createUser(CreateUserRequest request,
        ...
        try {
            ...
            UserEntity saved = customerRepository.save(entity);
        ...
        customerRepository.findById(request.getId())
                .ifPresentOrElse(
                    entity -> {
                        ...
                        UserEntity updated = customerRepository.save(entity);
                    ...
                    () -> responseObserver.onError(
                        Status.NOT_FOUND
                            .withDescription("Customer not found: " + request.getId())
                            .asRuntimeException()
                    )
                );
    }
    ...
    public void listUsers(ListUsersRequest request,
        ...
        Page<UserEntity> page = customerRepository.findAll(pageable);
...
public class UserServiceImpl extends UserServiceGrpc.UserServiceImplBase {
    ...
    public void getUser(GetUserRequest request,
        ...
        UserEntity entity = customerRepository.findById(request.getId())
...
public class UserServiceImpl extends UserServiceGrpc.UserServiceImplBase {
    ...
    public void getUser(GetUserRequest request,
        ...
        try {
            ...
            // Graceful degradation — return customer without accounts
            // or rethrow if accounts are critical
        }

        responseObserver.onNext(UserResponse.newBuilder()
                .setSuccess(true)
                .setMessage("Customer fetched")
                .setUser(toProto(entity))
...
try {
    ...
    log.warn("Could not fetch accounts for customer {}: {}", userId, e.getStatus());
